    ...
    return (
        <>
            ...
            <nav className={`w-full fixed px-4 sm:px-5 lg:px-8 xl:px-[8%] py-3 sm:py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:shadow-white/20" : ""}`}>
                ...
                {/* mobile menu */}
                <ul ref={sideMenuRef} className="flex md:hidden flex-col gap-4 py-20 px-6 sm:px-10 fixed -right-64 top-0 bottom-0 w-56 sm:w-64 z-50 h-screen bg-rose-50 transition duration-500 dark:bg-darkHover dark:text-white">
